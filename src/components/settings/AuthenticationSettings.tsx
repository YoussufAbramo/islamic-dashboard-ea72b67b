...
const AuthenticationSettings = () => {
  ...
  const providers = [
    ...
    },
    {
      ...
      name: 'Facebook',
      logo: <FacebookLogo />,
      description: isAr ? 'تسجيل الدخول باستخدام حساب Facebook' : 'Sign in with Facebook account',
    ...
    },
    {
      ...
      name: 'Microsoft',
      logo: <MicrosoftLogo />,
      description: isAr ? 'تسجيل الدخول باستخدام حساب Microsoft' : 'Sign in with Microsoft account',
