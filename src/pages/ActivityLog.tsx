...
const ActivityLog = () => {
  ...
  return (
    <ComingSoonOverlay
      icon={Activity}
      description="Activity Log will be available soon. You'll be able to track all actions and changes in the system."
      descriptionAr="سجل النشاطات سيكون متاحاً قريباً. ستتمكن من تتبع جميع الإجراءات والتغييرات في النظام."
    >
