...
import { CheckCircle, XCircle, Clock, UserCheck, ClipboardCheck, Download, User, GraduationCap } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview">
        <TabsList>
          ...
          <TabsTrigger value="students">{isAr ? 'الطالب' : 'Student'}</TabsTrigger>
          <TabsTrigger value="teachers">{isAr ? 'المعلم' : 'Teacher'}</TabsTrigger>
